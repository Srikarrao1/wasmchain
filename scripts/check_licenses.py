...
There are the following license types that are used in the project:
    - ENCL: This license is used for all files containing Anryton IP.
...
EXEMPT_FILES: List[str] = [
    ...
    r"proto/anryton/revenue/v1/",  # All files in this folder
    r"proto/anryton/claims/v1/genesis\.proto$",
]
