...
# Initialize chain.
anrytond init test --chain-id anryton_9000-2

# Get Genesis
wget https://archive.anryton.org/mainnet/genesis.json
mv genesis.json ~/.anrytond/config/

wget -O ~/.anrytond/config/adrbook.json https://snapshot.notional.ventures/anryton/addrbook.json
...
export ANRYTOND_P2P_MAX_NUM_INBOUND_PEERS=200
export ANRYTOND_P2P_MAX_NUM_OUTBOUND_PEERS=200
export ANRYTOND_STATESYNC_RPC_SERVERS="https://anryton-rpc.polkachu.com:443,https://rpc-anryton-ia.notional.ventures:443"
